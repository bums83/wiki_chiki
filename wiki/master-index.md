...
### [Легаси-железо](/wiki/infra/legacy-hardware/)
- **type:** concept
- **domain:** infra
...
### [Кайдзен](/wiki/management/kaizen/)
- **type:** concept
- **domain:** management
...
### [Poka-yoke и Andon](/wiki/management/poka-yoke-andon/)
- **type:** technology
- **domain:** management
...
### [Методология A3](/wiki/management/a3-methodology/)
- **type:** practice
- **domain:** management
...
### [Autoresearch](/wiki/llm-agents/autoresearch/)
- **type:** technology
- **domain:** llm-agents
...
### [Research org code](/wiki/llm-agents/research-org-code/)
- **type:** concept
- **domain:** llm-agents
...
### [Nanochat](/wiki/llm-agents/nanochat/)
- **type:** technology
- **domain:** llm-agents
...
### [Validation bits per byte](/wiki/llm-agents/validation-bits-per-byte/)
- **type:** concept
- **domain:** llm-agents
...
### [Overnight experimentation](/wiki/llm-agents/overnight-experimentation/)
- **type:** practice
- **domain:** llm-agents
...
### [Asynchronous research swarms](/wiki/llm-agents/asynchronous-research-swarms/)
- **type:** concept
- **domain:** llm-agents
