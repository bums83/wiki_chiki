...
перепишет текст. Не кладите весь SKILL.md в системный промпт чат-клиента:
это замедлит ответы, но не сделает разговор живее. Для диалога возьмите
короткие правила из [PERSONA.md](PERSONA.md).
