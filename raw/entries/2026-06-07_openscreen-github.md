---
id: github-siddharthvaddem-openscreen-2026-06-07
date: 2026-06-07
source_type: url
source_url: https://github.com/siddharthvaddem/openscreen
title: OpenScreen GitHub repository
domain: tools
tags: [tools, video, screen-recording, open-source, workflow]
---

# OpenScreen GitHub repository

Source: https://github.com/siddharthvaddem/openscreen

Repository metadata observed on 2026-06-07:

- Full name: `siddharthvaddem/openscreen`
- Description: Create polished demos for free; open-source alternative to Screen Studio
- Language: TypeScript
- License: MIT
- Stars: 38k+
- Status note from README: side project, not production grade, project says it will soon be archived
